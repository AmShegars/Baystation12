...
//Attack by mech fist system
	if(A == src)
		...
		if(do_after(src, 1.2 SECONDS, get_turf(src),DO_SHOW_PROGRESS|DO_TARGET_CAN_MOVE|DO_FAIL_FEEDBACK|DO_USER_CAN_TURN| DO_USER_UNIQUE_ACT | DO_PUBLIC_PROGRESS) && user)
